    ...
    public static class DynamicTypeBuilder
    {
        ...
        public static Type GetDynamicType(Dictionary<string, Type> fields, Type basetype, Type[] interfaces)
        {
            ...
            try
            {
                ...
                TypeBuilder typeBuilder = moduleBuilder.DefineType(typeName, TypeAttributes.Public | TypeAttributes.Class | TypeAttributes.Serializable, typeof(object), Type.EmptyTypes);

                foreach (var field in fields)
                {
                    FieldBuilder fieldBuilder = typeBuilder.DefineField(field.Key, field.Value, FieldAttributes.Public);
                    PropertyBuilder property = typeBuilder.DefineProperty(field.Key, PropertyAttributes.HasDefault, field.Value, null);
                }
